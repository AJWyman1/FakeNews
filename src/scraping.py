...
if __name__ == "__main__":
    ...
    url_u = "https://www.usatoday.com/story/news/health/2020/09/14/covid-19-news-donald-trump-indoor-rally-us-deaths/5786964002/"
    ...
    # print(text)
    print(s.text_from_html(response_html))

    print(s.abc_article(response_html))
